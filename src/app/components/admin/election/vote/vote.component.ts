...
export class VoteComponent implements OnInit {
  isError = false;
  isShow = true;
  constructor(private votingService: VotingService, private router: Router, private electionService: ElectionService, private route: ActivatedRoute) {
  ...
  doNavigation(data: ElectionData) {
    this.isShow = false;
    for (let algo of VOTING_ALGORITHMS) {
